...
# Se verifica si el usuario cerro la ventana.
    ...
    objeto = Pregunta(lista_pregunta[contador],[lista_respuesta_a[contador], lista_respuesta_b[contador], lista_respuesta_c[contador]],lista_respuesta_correcta[contador])
    ...
    if bandera_score_final:
        ...
        if contador_error < 2 and bandera_inicio != False and bandera_respuesta_correcta == False: 
            generar_y_dibujar_textos_respuestas_preguntas(objeto, lista_respuesta_a,lista_respuesta_b,lista_respuesta_c, lista_pregunta,score,titulo_score, pantalla,contador,COLOR_NEGRO,lista_respuesta_correcta)
        
        elif contador_error == 2 or bandera_respuesta_correcta == True:
            objeto.mostrar_pregunta(COLOR_NEGRO,(400,40),pantalla,(10, 230))
