...
def generar_y_dibujar_textos_respuestas_preguntas(objeto,lista_respuesta_a:list,lista_respuesta_b:list,lista_respuesta_c:list, 
                                                  lista_pregunta:list,score:pygame.surface.Surface,titulo_score:pygame.surface.Surface, 
                                                  pantalla: pygame.surface.Surface,contador:int,color:tuple,lista_respuesta_correcta):
    """
    ...
    if len(lista_respuesta_a) != 0 and len(lista_respuesta_b) != 0 and len(lista_respuesta_c) != 0 and len(lista_pregunta) != 0 and type(contador == int):
        if type(pantalla) == pygame.surface.Surface and type(color) == tuple and type(titulo_score) == pygame.surface.Surface and type(score) == pygame.surface.Surface:
            objeto = objeto
            objeto.mostrar_pregunta(color,(400,40),pantalla,(10, 230))
            objeto.mostrar_respuesta("a",color,(100,30),pantalla,(30, 320))      
            objeto.mostrar_respuesta("b",color,(100,30),pantalla,(210, 320)) 
            objeto.mostrar_respuesta("c",color,(100,30),pantalla,(390, 320)) 
            dibujar_texto(score,(200, 170),pantalla) #Se dibuja el texto.
            dibujar_texto(titulo_score,(200, 150),pantalla) #Se dibuja el texto. 
            
            """def mostrar_respuesta(self,letra:str,color,escala,pantalla):
            posicion = 0
            if letra == "a":
